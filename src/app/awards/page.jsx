...
async function page() {
    ...
    return (
            <div className="container px-2 mx-auto text-white md:px-5 xl:px-20">
                {awards?.status ? (
                    <>
                        <div className="grid md:grid-cols-2 gap-5 md:gap-20 xl:gap-52 2xl:gap-80 gap-y-10 my-16">
                            {awards.data.map((item) => (
                                <div data-aos="fade-up" data-aos-duration="1000" key={item.id} >
                                    <div className="relative h-[600px] md:h-[700px] xl:h-[900px] w-full  overflow-hidden rounded-2xl">
