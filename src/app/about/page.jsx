         ...
         <div data-aos="fade-right" data-aos-duration="1000" className='absolute left-0  sm:block top-24 sm:top-40 xl:top-96'>
            ...
            <div className="container mx-auto text-white md:px-5 ">
                <div className='relative'>
                    <div data-aos="fade-up" data-aos-duration="1000" className='sm:absolute flex flex-col items-center sm:block  sm:ms-5 mt-16 sm:mt-32 md:mt-32 xl:ms-20  md:w-[500px] z-40'>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000" className="relative ms-auto w-full h-[400px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[600px] lg:w-[600px] lg:h-[600px] xl:w-[650px] xl:h-[650px]  2xl:w-[670px] 2xl:h-[670px]">
                        ...
                        <Image data-aos="fade-up" data-aos-duration="1000" priority sizes='100vw'  className='w-[75%] h-[90%] m-auto absolute left-0 right-0  bottom-0' alt='amir-image-about' src={amirAbout} />
                    </div>
                </div>
