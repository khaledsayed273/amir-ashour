                    ...
                    <div className="container mx-auto md:mt-20 mb-5 px-5 h-full mt-16">
                        <div className=" flex flex-col-reverse md:flex-row justify-between items-center">
                            ...
                            <div className='flex items-center border-y py-4 md:py-0 md:border-0 w-full md:w-auto justify-center '>
                                <Link className='me-4 hover:rotate-[360deg] transition-all duration-500' href={"/"} aria-label="gmail">
                                ...
                                <Link className='me-4 hover:rotate-[360deg] transition-all duration-500' href={"/"} aria-label="whatsapp">
                                ...
                                <Link className='me-4 hover:rotate-[360deg] transition-all duration-500' href={"/"} aria-label="be">
                                    <svg width="25" viewBox="0 0 65 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Link className='me-4 hover:rotate-[360deg] transition-all duration-500' href={"/"} aria-label="youtube">
                                    <svg width="25" viewBox="0 0 65 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Link className='me-4 hover:rotate-[360deg] transition-all duration-500' href={"/"} aria-label="tiktok">
                                ...
                                <Link className='me-4 hover:rotate-[360deg] transition-all duration-500' href={"/"} aria-label="insta">
                                ...
                                <Link className='hover:rotate-[360deg] transition-all duration-500'  href={"/"} aria-label="facebook">
