    ...
    return (
        <section  className='relative  transition-all duration-700  text-white py-2 px-1 md:p-5'>
            ...
            <div className='flex justify-center items-center '>
                <Link className='bg-white flex justify-center items-center text-lg lg:text-2xl text-black static  lg:absolute lg:left-40 xl:left-60 2xl:left-64 -top-7 w-[140px]  lg:w-[268px] h-[40px] lg:h-[72px] rounded-full font-bold capitalize' href={"/contact"}>contact</Link>
            </div>
