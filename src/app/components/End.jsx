        ...
        <div className="container mx-auto p-3 mt-10">
            <div className='text-white relative h-[300px] md:h-[450px] overflow-hidden rounded-2xl mb-10'>
                ...
                <div className='absolute z-40 left-0 top-0 bottom-0 right-0 flex flex-col justify-center items-center'>
                    <svg className='w-[55px] md:w-[75px]' viewBox="0 0 75 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 className='mt-5 mb-2 md:text-3xl font-bold md:font-semibold'>Say something cool !</h1>
                    <h2 className='text-center text-sm md:text-xl font-normal'>Stay in the loop with updates from our team and community. </h2>
