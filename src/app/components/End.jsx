...
function End() {
    ...
    return (
        <div data-aos="fade-up" data-aos-duration="1000" className="container mx-auto p-3 mt-10 ">
            <div className='text-white relative h-[300px] md:h-[450px] overflow-hidden rounded-2xl mb-10'>
                ...
                <div className='absolute z-40 left-0 top-0 bottom-0 right-0 flex flex-col justify-center items-center'>
                    <svg data-aos="fade-up" data-aos-duration="1000" className='hover:rotate-[360deg] transition-all duration-500 w-[55px] md:w-[75px]' viewBox="0 0 75 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000" className='flex items-center flex-col md:flex-row mt-7  md:bg-white md:rounded-xl'>
                        ...
                        <button onClick={() => handleSend()} className='bg-orange-400 px-6 py-1.5 mt-3 md:mt-0 text-white rounded-xl font-semibold capitalize'>Subscribe to newsletter</button>
                    </div>
                </div>
            </div>
        </div>
